                    ...
                    while($registro = mysqli_fetch_assoc($resultado)){
                        echo"<div class="card bg-white shadow mb-3">"
                            <div class="card-body">
                                ...
                                <div class="d-flex">
                                    <p class="blog-post-meta mr-3"><i class="fas fa-clock    "></i> 3 de agosto del 2010</p>
                                    <p class="blog-post-meta mr-3"><i class="fa fa-user" aria-hidden="true"></i> Fulanito</p>
                                    <p class="blog-post-meta mr-3"><i class="fa fa-folder" aria-hidden="true"></i> Categoria</p>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <p class="card-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                                                Explicabo itaque
                                                architecto qui nulla dolores esse modi omnis eum soluta deserunt repudiandae,
                                                placeat
                                                eligendi magnam, officiis error excepturi commodi dolore quisquam.</p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card-footer text-muted">
                                <a name="asdasd" id="asdasd" class="btn btn-dark float-right" href="posts/post.html"
                                    role="button">
                                    Ir
                                    al
